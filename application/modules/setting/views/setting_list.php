          ...
          <div class="">
            <div class="form-group label-floating">
              ...
              <select name="setting_level" class="form-control">
                <option value="primary" <?php echo ($setting_level['setting_value'] == 'primary') ? 'selected' : '' ?>>SDIT</option>
                <option value="junior" <?php echo ($setting_level['setting_value'] == 'junior') ? 'selected' : '' ?>>SMPIT</option>
                <option value="senior" <?php echo ($setting_level['setting_value'] == 'senior') ? 'selected' : '' ?>>SMKIT</option>
              </select>
            </div>
          </div>
        </div>
