...
<head>
  ...
  <title>SPP-Nurul Qolbi | Login</title>
    ...
    <div class="col-md-5">
      <div class="logo hidden-xs hidden-sm">
        <?php if (isset($setting_logo) and $setting_logo['setting_value'] == NULL) { ?>
          <img src="<?php echo media_url('img/logonq.png') ?>" class="img-responsive">
        <?php } else { ?>
          <img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" class="img-responsive">
        <?php } ?>
      </div>
      <p class="merk"><span style="color: #2ABB9B">SPP</span> Nurul Qolbi</p>
      <?php if (isset($setting_school) and $setting_school['setting_value'] == '-') { ?>
        <p class="school">Sistem Pembayaran Nurul Qolbi</p>
      <?php } else { ?>
