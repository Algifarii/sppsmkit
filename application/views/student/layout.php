    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('student') ?>" class="logo">
        ...
        <?php if (!empty(logo())) { ?>
          ...
          <span class="logo-lg"><img src="<?php echo upload_url('school/' . logo()) ?>" style="height: 40px; margin-top: 5px;" class="pull-left"></span>
        <?php } else { ?>
          <span class="logo-lg"><img src="<?php echo media_url('img/logo.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"></span>
        <?php } ?>
      </a>
