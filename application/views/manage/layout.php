...
<head>
  ...
  <title>SPP NURUL QOLBI</title>
  <!-- <title><?php echo $this->config->item('app_name') ?> <?php echo isset($title) ? ' | ' . $title : null; ?></title> -->
  <link rel="icon" type="image/png" href="<?php echo media_url('img/logonq.png') ?>">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('manage') ?>" class="logo">
        ...
        <?php } else { ?>
          <span class="logo-mini"><img src="<?php echo media_url('img/logonq.png') ?>" style="height: 40px; margin-top: 5px; margin-left:5px;" class="pull-left"></span>
        <?php } ?>
        <?php if (!empty(logo())) { ?>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg pull-left"><img src="<?php echo upload_url('school/' . logo()) ?>" style="height: 40px; margin-top: 5px;" class="pull-left">
          <?php } else { ?>
            <span class="logo-lg pull-left"><img src="<?php echo media_url('img/logonq.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left">
            <?php } ?>
      </a>
