		...
		<div class="navbar-header">
			<a class="navbar-brand" href="">
				<?php if (isset($setting_logo) and $setting_logo['setting_value'] != NULL) { ?>
					<img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" style="height: 40px; margin-top: -10px; margin-right: 40px;" class="pull-left">
				<?php } else { ?>
					<img src="<?php echo media_url('img/logonq.png') ?>" style="height: 40px; margin-top: -10px; margin-right: 5px;" class="pull-left">
